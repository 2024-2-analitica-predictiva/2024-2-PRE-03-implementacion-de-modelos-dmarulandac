...
class LinearRegression:
    ...
    def __init__(self, num_epochs=100, learning_rate=0.01):
        ...
        self.num_epochs = num_epochs #parametros del modelo
    ...
    def fit(self, X, y):
        ...
        for _ in tqdm(range(self.num_epochs)): #tqdm es para la barra de avance 
            #se importa, se pega en el ciclo for, cuando se den las iteraciones
            #se presenta en pantalla la barra de progreso
            #inidicativo de cuanto se demora ejecutando

            # Compute the predictions
            y_pred = np.matmul(X, self.coefs_) + self.intercept_ #mult matricial
            ...
            # Update the coefficients - gradiente descendeinte
